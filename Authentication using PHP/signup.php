...
<body>
    ...
    <form action="" method="POST">
        ...
        <button type="submit" name="submit-btn">Signup</button>
    ...
    if(isset($_POST['submit-btn'])) {
        ...
        // else check the password and confirm password equation
            ...
            // else Encrypt the password and execute insert query and create the account
                ...
                $create_account_query = "INSERT INTO `user_info`( `username`, `email`, `password`, `birthdate`, `phone`) VALUES ('$username','$email','$encrypted_password','$birthdate','$phone')";
